...
async function displayCharts(submissionSeriesList) {
...
async function asyncMain() {
    ...
    for await (const value of await interceptApiToValues()) {
        ...
        const series = await backgroundModule.calculateSubmissionSeriesFromManageResponse(r, names);
